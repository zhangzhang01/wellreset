...
//    UIBarButtonItem *item = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"nav_back"] style:UIBarButtonItemStylePlain target:self action:@selector(onClickedBarButtomItem:)];
...
-(IBAction)onClickedBarButtomItem:(UIBarButtonItem*)sender
{
    ...
    if (sender == self.navigationItem.rightBarButtonItem) {
        ...
        [WRViewModel operationWithType:OperationTypeUserCommonDisease indexId:uuidString actionType:OperationActionTypeAdd contentType:OperationContentTypeUnknown completion:^(NSError * _Nonnull error) {
