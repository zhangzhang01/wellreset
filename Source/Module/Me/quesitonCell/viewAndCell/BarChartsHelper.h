...
@interface BarChartsHelper : UIView
...
//双柱靠拢折线图
//- (void)createBarChartViewWithBarViewxVals:(NSArray *)xVals lineValues:(NSArray *)lineVals  bar1Vals:(NSArray *)bar1Vals bar2Vals:(NSArray *)bar2Vals title:(NSString *)title lineTitle:(NSString *)line bar1Title:(NSString *)bar1 bar2Title:(NSString *)bar22;
