...
+(instancetype)wr_lineBorderButtonWithTitle:(NSString*)title {
    ...
    dispatch_once(&once_t, ^{
        normalImage = [Utility createImageWithColor:[UIColor wr_rehabBlueColor]];
    ...
    [btn setTitleColor:[UIColor wr_rehabBlueColor] forState:UIControlStateHighlighted];
...
+(instancetype)wr_defaultButtonWithTitle:(NSString *)title {
    UIImage *normalImage = [Utility createImageWithColor:[UIColor whiteColor]];
    UIImage *highImage = [Utility createImageWithColor:[UIColor whiteColor]];
    UIImage *disableImage = [Utility createImageWithColor:[UIColor grayColor]];
    ...
    [btn setTitle:title forState:UIControlStateNormal];
    [btn setTitleColor:[UIColor wr_themeColor] forState:UIControlStateNormal];
    [btn setTitleColor:[UIColor wr_themeColor] forState:UIControlStateHighlighted];
...
//
//
//    CGRect rectBig = CGRectInset(self.bounds, -20, -20);
//
