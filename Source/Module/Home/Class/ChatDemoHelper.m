...
- (void)userAccountDidLoginFromOtherDevice
{
    ...
    PayImViewModel* viewModel = [PayImViewModel new];
    [viewModel fetchAlreadyOrdercompletion:^(NSError * _Nonnull error) {
        if (viewModel.orderlist.count!=0) {
            ...
            [self.mainVC presentViewController:navi animated:NO completion:^{
