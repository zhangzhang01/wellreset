...
//                NSLog(@"AVPlayerStatusReadyToPlay");
                ...
                //            [selvideoSliderf customVideoSlider:duration];// 自定义UISlider外观
...
//        NSLog(@"计算当前在第几秒。。。%f",currentSecond);
...
-(void)setHideControls:(BOOL)hideControls
{
    ...
    self.controlBar.hidden = hideControls;
}
...
-(BOOL)isFullScreen {
    return self.frame.size.width == YYScreenSize().height;
}
#if 0
