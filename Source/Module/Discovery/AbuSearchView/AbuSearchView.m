...
-(void)ajustIconWith:(AbuSearchBarIconAlign)iconAlign{
    if (_iconAlign == SearchBarIconAlignCenter) { //是否居中
        ...
        self.textField.frame = CGRectMake(7, 0, self.frame.size.width-7*2, 26);
...
- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField
{
    ...
    [UIView animateWithDuration:0.1 animations:^{
        ...
        _textField.frame = CGRectMake(7, 0, _cancelButton.frame.origin.x-7, 26);
...
- (void)textFieldDidEndEditing:(UITextField *)textField
{
    ...
    [UIView animateWithDuration:0.1 animations:^{
        ...
        _textField.frame = CGRectMake(7, 0, self.frame.size.width-7*2, 26);
        //        _textField.transform = CGAffineTransformMakeTranslation(-_cancelButton.frame.size.width,0);
    }];
...
{
    if (!_textField) {
        _textField = [[UITextField alloc] initWithFrame:CGRectMake(7, 0, self.frame.size.width-7*2, 26)];
