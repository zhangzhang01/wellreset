...
- (void)setButton:(UIButton *)btn BackgroundWithButonType:(JCAlertViewButtonType)buttonType{
    ...
    switch (buttonType) {
        case JCAlertViewButtonTypeDefault:
            ...
            normalImage = [Utility createImageWithColor:[UIColor whiteColor]];
            highImage = [Utility createImageWithColor:[UIColor wr_themeColor]];
        ...
        case JCAlertViewButtonTypeCancel:
            ...
            normalImage = [Utility createImageWithColor:[UIColor whiteColor]];
            highImage = [Utility createImageWithColor:[UIColor grayColor]];
            textColor = [UIColor grayColor];//JCColor(255, 255, 255);
            [btn setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
            btn.layer.borderWidth = 1.f;
