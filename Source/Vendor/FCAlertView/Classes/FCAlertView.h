...
@property (nonatomic, weak, nullable) id<FCAlertViewDelegate> delegate;
...
- (void) showAlertInView:(UIViewController * __nullable)view withTitle:(NSString *)title withSubtitle:(NSString *)subTitle withCustomImage:(UIImage * __nullable)image withDoneButtonTitle:(NSString * __nullable)done andButtons:(NSArray * __nullable)buttons;
