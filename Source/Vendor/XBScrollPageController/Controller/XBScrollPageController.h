...
@property UIView * tagbackground;
@property UIView * tagbac;
@property NSMutableArray* arr;
@property NSMutableArray* bao;
@property NSMutableArray* quan;
@property NSString* quantype;
@property NSString* number;
@property NSMutableArray* choosearr;
@property NSMutableArray* usearr;
