...
//    [self.navigationController.navigationBar setBackgroundImage:[CustomNavigationController imageWithColor:[UIColor whiteColor]] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
//    [self.navigationController.navigationBar  setShadowImage:[CustomNavigationController imageWithColor:[UIColor colorWithHexString:@"#eeeeee"]]];
...
- (void)viewDidLayoutSubviews
{
    ...
    if (self.isindex) {
        CGRect r=  self.tagCollectionView.frame;
        //        [self.view bringSubviewToFront:self.tagbackground];
        //        [self.view bringSubviewToFront:self.tagbac];
...
//        r.origin.y=1;
        r.size.height=40;
        //
        //        self.tagCollectionView.layer.cornerRadius=44/2;
        //        self.tagCollectionView.layer.masksToBounds=YES;
        //        self.tagCollectionView.layer.borderColor=[UIColor colorWithRed:255/255 green:255/255 blue:255/255 alpha:0.3].CGColor;
        //        self.tagCollectionView.layer.borderWidth=3;
        self.tagCollectionView.frame=r;
        //
        //        r.size.width+=6;
        //        r.origin.x=20;
...
- (void)setupDefaultProperties
{
    ...
    self.selectedIndicatorColor = _selectedIndicatorColor;
    self.tagItemSize = _tagItemSize;
...
- (void)setupCollectionView
{
    ...
    {
        tagCollectionView.prefetchingEnabled=NO;
    }
    ...
    if ([NSProcessInfo.processInfo isOperatingSystemAtLeastVersion:(NSOperatingSystemVersion){10,0,0}])
    {
        pageCollectionView.prefetchingEnabled=NO;
    }
