...
//    [_scrollview addSubview:_locationButton];
    ...
    [_takePicButton setImage:[UIImage imageNamed:@"相机"] forState:UIControlStateNormal];
//    [_takePicButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_colorMore_cameraSelected"] forState:UIControlStateHighlighted];
    ...
    if (type == EMChatToolbarTypeChat) {
        ...
        [_audioCallButton setImage:[UIImage imageNamed:@"语音"] forState:UIControlStateNormal];
...
//        [_videoCallButton setFrame:CGRectMake(insets*4, 10 * 2 + CHAT_BUTTON_SIZE + 10, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
