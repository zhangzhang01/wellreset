...
#define FOREGROUND_STAR_IMAGE_NAME @"icon_star_white"
...
@property(nonatomic, strong)UIImage *foregroundImage, *backgroundImage;
...
- (instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars backgroundImage:(UIImage *)backgroundImage foregroundImage:(UIImage *)foregroundImage
{
    if (self = [super initWithFrame:frame])
    {
        _numberOfStars = numberOfStars;
...
- (void)buildDataAndUI {
    ...
    if (!self.backgroundImage) {
        self.backgroundImage = [UIImage imageNamed:BACKGROUND_STAR_IMAGE_NAME];
    }
    if (!self.foregroundImage) {
        self.foregroundImage = [UIImage imageNamed:FOREGROUND_STAR_IMAGE_NAME];
    }

    self.foregroundStarView = [self createStarViewWithImage:self.foregroundImage];
    self.backgroundStarView = [self createStarViewWithImage:self.backgroundImage];
