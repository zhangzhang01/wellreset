...
//    [self showToast:toast duration:interval position:[NSValue valueWithCGPoint:CGPointMake(SCREEN_WIDTH/2.0, SCREEN_HEIGHT/2.0)]];
//}
...
- (void)showToast:(UIView *)toast duration:(CGFloat)interval position:(id)point
{
    ...
    [UIView animateWithDuration:CSToastFadeDuration delay:0.0 options:UIViewAnimationOptionCurveEaseOut animations:^{
                         ...
                         [UIView animateWithDuration:CSToastFadeDuration delay:interval options:UIViewAnimationOptionCurveEaseIn animations:^{
                                              toast.alpha = 0.0;
                                          } completion:^(BOOL finished) {
...
- (void)hideToastActivity
{
    ...
    {
        [UIView animateWithDuration:CSToastFadeDuration delay:0.0 options:(UIViewAnimationOptionCurveEaseIn | UIViewAnimationOptionBeginFromCurrentState) animations:^{
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image
{
    ...
    wrapperView.backgroundColor = [COLOR(0, 0, 0, 0.9) colorWithAlphaComponent:CSToastOpacity];
