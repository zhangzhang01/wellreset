...
#define PayOrderInfoKey  @"PayOrderInfoKey"
...
typedef NS_ENUM(NSInteger, QuestionControllerStyle)
{
    QuestionControllerDefault, //title label is in center
    QuestionControllerNew,
};
